...
class OllamaIntegration:
    ...
    def generate_response(self, prompt: str, model: str = None, system_prompt: str = None, timeout: int = 15) -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            timeout: Request timeout in seconds (default: 15 for faster responses)
...
'''
    ...
    def process_query(self, user_input: str, model: str = "llama3", timeout: int = 15, system_prompt_override: Optional[str] = None) -> str:
        """
